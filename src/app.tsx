...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState([
    'jessica.white44@yahoo.com', 'rudy@gmail.com'
  ])
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-3'>
            ...
            <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
              ...
              <button type='submit' className='flex items-center gap-2 bg-lime-300 px-5 py-2 font-medium rounded-lg text-lime-950 hover:bg-lime-400'>
                Convidar
