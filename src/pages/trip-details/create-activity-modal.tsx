                ...
                <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                  ...
                  <form className='space-y-3'>
                    <div className='h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                      ...
                      <input className="bg-transparent placeholder-zinc-400 text-lg w-24 outline-none flex-1" type="text" name='title' placeholder="Qual a atividade?"/>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className='h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2 flex-1'>
                            <Calendar className='size-5 text-zinc-400'/>
                            <input className="bg-transparent placeholder-zinc-400 text-lg w-24 outline-none flex-1" 
                                type="datetime-local" 
                                name='occurs_at' 
